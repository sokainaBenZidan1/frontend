...
@Component({
  selector: 'app-employe-salaire-history-create-admin',
  templateUrl: './employe-salaire-history-create-admin.component.html'
})
export class EmployeSalaireHistoryCreateAdminComponent extends AbstractCreateController<EmployeSalaireHistoryDto, EmployeSalaireHistoryCriteria, EmployeSalaireHistoryAdminService>  implements OnInit {
