            ...
            [
                {
                    ...
                    children: [
...

                        {
                            ...
                            path: 'taxe-lotissement',
                            children: [
                                {
                                    path: 'list',
                                    component: TaxeLotissementListAdminComponent ,
                                    canActivate: [AuthGuard]
                                }
                            ]
                        },

                        {
                            ...
                            path: 'taux-taxe-lotissement',
                            children: [
                                {
                                    path: 'list',
                                    component: TauxTaxeLotissementListAdminComponent ,
                                    canActivate: [AuthGuard]
                                }
                            ]
                        },
...
export class LotissementAdminRoutingModule { }
